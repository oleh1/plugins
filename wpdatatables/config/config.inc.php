...
define( 'WDT_CURRENT_VERSION', 'Lite 1.1' );
define( 'WDT_TIMEOUT_FACTOR', 5 ); // path to wpDataTables templates. You should not change this setting if you use default templates
...
define( 'WDT_VALIDATE_COEFFICIENT', 30 ); // path to wpDataTables templates. You should not change this setting if you use default templates
