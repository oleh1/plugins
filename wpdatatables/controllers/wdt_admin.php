...
<?php
        ...
        $wdt_admin_translation_array = array(
			...
			,'table_full_version_option' => __('Sorry, this function is available only in FULL version of wpDataTables along with many others! Please go to our <a href="http://wpdatatables.com/?utm_source=wdtlite">website</a>
to see the full list and to purchase!')
	        );
	 ...
	 */
		...
		$tpl->setTemplate( 'settings.inc.php' );
			$tpl->addData('wdtSiteLink', get_option('wdtSiteLink'));
