...
(function(Handsontable, $){
    ...
    function initWdtDateEditor() {
        ...
        var prepareWdtColumnValidate = function (value, row, prop, source){
            ...
            if( col_type == 'wdt.date' ) {
                ...
                var table_settings = this.getSettings();
        ...
        ExcelDateEditor.prototype.finishEditing = function( revertToOriginal, ctrlDown, callback ) {
            var hdt = this.instance;

            if ( !this.same_display_and_edit_format ) {
                hdt.addHook('beforeValidate', prepareWdtColumnValidate);
            }

            Handsontable.editors.DateEditor.prototype.finishEditing.apply(this, arguments);

            if ( !this.same_display_and_edit_format ) {
                hdt.removeHook('beforeValidate', prepareWdtColumnValidate);
            }
        };
